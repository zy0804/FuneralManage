...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/sellManage/addSell.js"></script>
    <style type="text/css">
      body,td,th {
	    font-size: 18px;
      }
  ...
  <form id="form1" name="form1" method="post" action="" onsubmit="return saveSellInfo();">
      <table>
        <tr>
          ...
          <td>销售日期：</td>
          <td><input type="text" id="sellDate" name="sellDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',readOnly:true,minDate:'%y-%M-{%d}'})" onchange="checkDate();"></td>
          <td>销售仓库：</td>
