...
<html>
  <head>
	...
	<script type="text/javascript" src="js/purchaseManage/auditPurchase.js"></script>
	<style type="text/css">
      body,td,th {
	    font-size: 18px;
      }
  ...
  <body>
    <form id="form1" name="form1" method="post" action="" onsubmit="return saveAuditInfo();">
      <table>
        <tr>
          <td>采购编号:</td>
        ...
        <tr>
          ...
          <td id="financeCol"><input type="text" id="financeAudit" name="financeAudit"/></td>
          <td id="viceCurator" style="display:none;">分馆长审批人:</td>
          <td id="viceCuratorCol" style="display:none;"><input type="text" id="viceCuratorAudit" name="viceCuratorAudit"/></td>
          <td id="curator" style="display:none;">馆长审批人:</td>
          <td id="curatorCol" style="display:none;"><input type="text" id="curatorAudit" name="curatorAudit"/></td>
          <td>审核结果:</td>
          <td>
