...
body,td,th {
  ...
  <body>
    ...
    <hr>
    <div style="font-weight: bold;font-family:黑体;color:blue;">修改租棺信息：</div>   
    <div id="search" >
    <table>
       <tr>
          <td>水晶棺编号：</td>
    ...
    <input type="submit" id="save" value="删除" onclick="deleteCoffinInfo()">  
    </div> 
  </body>
</html>
