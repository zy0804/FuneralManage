...
var getReceipt = function(receiptNumber)
{
	...
	var url = "/FuneralManageSystem/cancelAuditReceipt!getReceipt";
...
var getReceiptBack = function(result)
{
	...
	for (var i = 0; i < data.length; i++)
	{
		...
		document.getElementById("audit").value = data[i].audit;
...
{
	var data = "receiptNumber=" + receiptNumber;
	var url = "/FuneralManageSystem/cancelAuditReceipt!getReceiptDetails";
...
var saveCancelAuditInfo = function()
{
	...
	var data = "receiptNumber=" + receiptNumber + "&purchaseNumber=" + purchaseNumber
		+ "&warehouseName=" + warehouseName + "&details=" + getDetails();
	var url = "/FuneralManageSystem/cancelAuditReceipt!saveCancelAuditInfo";
