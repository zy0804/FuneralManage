			...
			if (json.flag == "1") {
				...
				if (json.deadResidence != "") {
					for (var i = 0; i < document
							.getElementById("deadResidence").options.length; i++) {
				...
				if (json.operatorRelation != "") {
					for (var i = 0; i < document
							.getElementById("operatorRelation").options.length; i++) {
				...
				// var operatorRelationIndex =
				// operatorRelationSelect.selectedIndex;
				...
				if (json.ashesDisposition != "") {
					for (var i = 0; i < document
							.getElementById("ashesDisposition").options.length; i++) {
				...
				form4.theWholeCost.value = parseInt(form4.theWholeCost.value)
						- parseInt(form4.lastWholeCost.value)
						+ parseInt(json.remainsCarryRealCost)
						+ parseInt(json.rentCrystalRealCost)
						+ parseInt(json.rentCrystalCarRealCost)
						+ parseInt(json.watchSpiritVillaRealCost)
						+ parseInt(json.watchSpiritCoffinRealCost);
				form4.lastWholeCost.value = parseInt(form4.remainsCarryRealCost.value)
						+ parseInt(form4.rentCrystalRealCost.value)
						+ parseInt(form4.rentCrystalCarRealCost.value)
						+ parseInt(form4.watchSpiritVillaRealCost.value)
						+ parseInt(form4.watchSpiritCoffinRealCost.value) + "";

				form4.allBeCost.value = parseInt(form4.theWholeCost.value)
						+ parseInt(form4.remainsCarryBeCost.value)
						+ parseInt(form4.rentCrystalBeCost.value)
						+ parseInt(form4.rentCrystalCarBeCost.value)
						+ parseInt(form4.watchSpiritVillaBeCost.value)
						+ parseInt(form4.watchSpiritCoffinBeCost.value)
						- parseInt(json.remainsCarryRealCost)
						- parseInt(json.rentCrystalRealCost)
						- parseInt(json.rentCrystalCarRealCost)
						- parseInt(json.watchSpiritVillaRealCost)
...
function getLeaveRoomBeCost() {
	...
	if (leaveRoomName != "-请选择-") {
		...
		http_request.open('POST', "GetServiceBeCostAction!getServiceBeCost",
				false);
		http_request.setRequestHeader("Content-Type",
				"application/x-www-form-urlencoded");
		http_request.send(url);
...
function getRemainNumber(form2) {
	...
	http_request.open('GET', "GenerateRemainNumberAction!makeRemainNumber",
			false);
	http_request.setRequestHeader("Content-Type",
			"application/x-www-form-urlencoded");
...

{
	...
	/*
	 * if(form.deadSex.value=="") { alert("逝者性别不能为空！"); form.deadSex.focus();
	 * return false; }
	 */
	...
	/*
	 * if(form.deadType.value=="") { alert("死亡类型不能为空！"); form.deadType.focus();
	 * return false; }
	 */
	...
	http_request.open('POST', "DeadInfoRegisterAction!registOrderDeadInfo",
			false);
	http_request.setRequestHeader("Content-Type",
			"application/x-www-form-urlencoded");
	http_request.send(url);
...
function decideYourChoose() {
	...
	for (var i = 2; i < len; i++) {
		...
		if (goodsCheckBoxInput1[0].checked) {
			...
			var goodsBeCostInput = tableName.rows[i].cells[1]
					.getElementsByTagName("input");
		...
		if (goodsCheckBoxInput2[0] != null) {
			if (goodsCheckBoxInput2[0].checked) {
				...
				var goodsBeCostInput = tableName.rows[i].cells[9]
						.getElementsByTagName("input");
				var goodsBeCost = goodsBeCostInput[0].value;
		...
		if (http_request.status == 200) {
			...
			for (var i = 0; i < length; i++) {
				...
				if (CremationTypeNo == "03" && status == "2") {
					...
					document.getElementById("cremationRealCost").value = document
							.getElementById("cremationBeCost").value
							- document.getElementById("cremationRealCost").value;
					document.getElementById("preCremationRealCost").value = document
							.getElementById("cremationRealCost").value;
				...
				if (CremationTypeNo == "02" && status == "2") {
					...
					document.getElementById("leaveRoomRealCost").value = document
							.getElementById("leaveRoomBeCost").value
					...
					document.getElementById("preLeaveRoomRealCost").value = document
							.getElementById("leaveRoomRealCost").value;
				...
				if (CremationTypeNo == "01" && status == "2") {
					...
					document.getElementById("makeBeautyRealCost").value = document
							.getElementById("makeBeautyRealCost").value
							- document.getElementById("makeBeautyBeCost").value;
					document.getElementById("preMakeBeautyBeCost").value = Number(jsonValue2[i].itemBeCost);
					document.getElementById("preMakeBeautyRealCost").value = document
							.getElementById("makeBeautyRealCost").value;
				...
				if (CremationTypeNo == "01" && status == "0") {
					...
					document.getElementById("makeBeautyRealCost").value = Number(jsonValue2[i].itemRealCost);
					document.getElementById("makeBeautyRealCost").value = document
							.getElementById("makeBeautyBeCost").value
				...
				if (jsonValue2[i].urnName != null) {
					...
					document.getElementById("urnRealCost").value = Number(document
							.getElementById("urnBeCost").value)
							- Number(document.getElementById("urnRealCost").value);
					document.getElementById("preUrnRealCost").value = Number(document
							.getElementById("urnRealCost").value);
			...
			document.getElementById("allBeCost").value = Number(document
					.getElementById("allBeCost").value)
					+ Number(cremationBeCost)
					+ Number(makeBeautyBeCost)
					+ Number(leaveRoomBeCost) + Number(urnBeCost);
			document.getElementById("allRealCost").value = Number(document
					.getElementById("allRealCost").value)
					+ Number(cremationRealCost)
					+ Number(makeBeautyRealCost)
					+ Number(leaveRoomRealCost) + Number(urnRealCost);
			changeGood(deadId1);
			var table2 = document.getElementById("showallFuneralGoods");
			var rows = table2.rows.length;

			for (var k = 2; k < rows; k++) {
				var reduceMoney = table2.rows[k].cells[2]
						.getElementsByTagName("input");
				var reduceMoney1 = table2.rows[k].cells[9]
						.getElementsByTagName("input");
				...
				if (reduceMoney[0].value != 0) {
					document.getElementById("allRealCost").value = Number(document
							.getElementById("allRealCost").value)
							+ Number(reduceMoney[0].value);
				}
				if (reduceMoney1[0].value != 0) {
					document.getElementById("allRealCost").value = Number(document
							.getElementById("allRealCost").value)
							+ Number(reduceMoney1[0].value);

				}

			}
			document.getElementById("theWholeCost").value = Number(document
					.getElementById("allBeCost").value)
					- Number(document.getElementById("allRealCost").value);
			...
			if (document.getElementById("beauty").value != null) {
				...
				var makeBeautyGrade = document
						.getElementById("makeBeautyGrade");

				setSelected(makeBeautyGrade,
						document.getElementById("beauty").value)
			...
			if (document.getElementById("cremationstove").value != null) {
				...
				setSelected(cremationGrade, document
						.getElementById("cremationstove").value)
...
function outPutServiceList() {
	...
	var watchSpiritCost = parseInt(form4.watchSpiritVillaBeCost.value)
			+ parseInt(form4.watchSpiritCoffinBeCost.value);
	var watchSpiritRealCost = parseInt(form4.watchSpiritVillaRealCost.value)
			+ parseInt(form4.watchSpiritCoffinRealCost.value);
	...
	if (car2Cost != 0) {
		document.getElementById("car4").innerHTML = "<font style='font-weight:bold;'>"
				+ car2Cost + "</font>";
		var charge4 = car2Cost - car2RealCost;
		if (charge4 != 0) {
			document.getElementById("car5").innerHTML = "<font style='font-weight:bold;'>"
					+ "-" + charge4 + "</font>";
		}
	}
	if (crystalCost != 0) {
		document.getElementById("crystal").innerHTML = "<font style='font-weight:bold;'>"
				+ "8元/时" + "</font>";
		document.getElementById("crystal1").innerHTML = "<font style='font-weight:bold;'>"
				+ crystalCost + "</font>";
		var charge1 = crystalCost - crystalRealCost;
		if (charge1 != 0) {
			document.getElementById("crystal2").innerHTML = "<font style='font-weight:bold;'>"
					+ "-" + charge1 + "</font>";
		}
	}
	if (watchSpiritCost != 0) {

		document.getElementById("watch1").innerHTML = "<font style='font-weight:bold;'>"
				+ watchSpiritCost + "</font>";
		var charge2 = watchSpiritCost - watchSpiritRealCost;
		if (charge2 != 0) {
			document.getElementById("watch2").innerHTML = "<font style='font-weight:bold;'>"
					+ "-" + charge2 + "</font>";
		}
	}
...
function sumCost() {
	...
	var rentCrystalCostChange = Number(rentCrystalBeCost)
			- Number(rentCrystalRealCost);

	var rentCrystalCarBeCost = document.getElementById("rentCrystalCarBeCost").value;
	var rentCrystalCarRealCost = document
			.getElementById("rentCrystalCarRealCost").value;
	var rentCrystalCarCostChange = Number(rentCrystalCarBeCost)
			- Number(rentCrystalCarRealCost);

	var watchSpiritVillaBeCost = document
			.getElementById("watchSpiritVillaBeCost").value;
	var watchSpiritVillaRealCost = document
			.getElementById("watchSpiritVillaRealCost").value;
	var watchSpiritVillaCostChange = Number(watchSpiritVillaBeCost)
			- Number(watchSpiritVillaRealCost);

	var watchSpiritCoffinBeCost = document
			.getElementById("watchSpiritCoffinBeCost").value;
	var watchSpiritCoffinRealCost = document
			.getElementById("watchSpiritCoffinRealCost").value;
	var watchSpiritCoffinCostChange = Number(watchSpiritCoffinBeCost)
			- Number(watchSpiritCoffinRealCost);
	...
	var sumBeCost = Number(remainsCarryBeCost) + Number(rentCrystalBeCost)
			+ Number(rentCrystalCarBeCost) + Number(watchSpiritVillaBeCost)
			+ Number(watchSpiritCoffinBeCost) + Number(leaveRoomBeCost)
			+ Number(urnBeCost) + Number(makeBeautyBeCost)
			+ Number(cremationBeCost);
	var sumRealCost = Number(remainsCarryBeCost) - Number(remainsCarryRealCost)
			+ rentCrystalCostChange + rentCrystalCarCostChange
			+ watchSpiritVillaCostChange + watchSpiritCoffinCostChange
			+ Number(leaveRoomRealCost) + Number(urnRealCost)
			+ Number(makeBeautyRealCost) + Number(cremationRealCost);
	var tableName = document.getElementById("allFuneralGoods"); // 获取table中丧葬物品对象
	var len = tableName.rows.length;
	for (var i = 2; i < len; i++) {
		var goodsCheckBoxInput1 = tableName.rows[i].cells[4]
