	...
	<table height="100%" width="100%" border="1" background="Images/TitleBackground.jpg">
		...
		<tr height="8%">
			<td width="100%" align="center">
				<a href="right-zhenghuo.jsp" target="right" style="font-size:20px">业务登记</a>
			</td>
		</tr>
		<tr height="8%">
			<td width="100%" align="center">
		...
		<tr height="8%">
			<td width="100%" align="center">
				<a href="warehouseMoveManage.jsp" target="right" style="font-size:20px">仓库调拨</a>
			</td>
		</tr>
		
		<tr height="8%">
			<td width="100%" align="center">
				<a href="warehouseCheckManage.jsp" target="right" style="font-size:20px">仓库盘点</a>
			</td>
		</tr>
		<!-- by jixiang end -->
		...
		<tr height="8%">
			<td width="100%" align="center">
				<label><font size="2" color="white">研发团队：江苏科技大学4S团队<br>联系QQ：136527411</font></label>
			</td>
		</tr>
	</table>
</body>
