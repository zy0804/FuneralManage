...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/sellManage/querySell.js"></script>
  ...
  <body>
    <table>
      ...
      <tr>
        <td colspan="6" align="right"><input type="button" id="queryButton" name="queryButton" value="查询" onclick="searchSell();"/></td>
      </tr>
    </table><br>
    <table id="table" border="1" style="table-layout:fixed; width:650px; word-wrap:break-word; word-break:break-all;">
      <thead>
        ...
        <th style="width:150px;">销售日期</th>
        <th style="width:100px;">销售仓库</th>
