...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/warehouseCheckManage/queryWarehouseCheck.js"></script>
  ...
  <body>
    <table>
      ...
      <tr>
        <td colspan="6" align="right"><input type="button" id="queryButton" name="queryButton" value="查询" onclick="searchWarehouseCheck();"/></td>
      </tr>
    </table><br>
    <table id="table" border="1" style="table-layout:fixed; width:650px; word-wrap:break-word; word-break:break-all;">
      <thead>
        <th style="width:100px;">盘点单号</th>
        <th style="width:100px;">业务人员</th>
        <th style="width:150px;">盘点日期</th>
        <th style="width:100px;">盘点仓库</th>
