...
<div id="TabbedPanels1" class="TabbedPanels">
  ...
  <!--———————————————————————————————2.预约遗体挂号—————————————————————————————————————————————————-->
	<div class="TabbedPanelsContent">
          <form name="form2" onSubmit="return validateForm2(this);">
            <p>
              ...
              <input type="button" name="confirm" id="DeadIdConfirm" value="查询" style="width: 60px;" onClick="form2Data(document.forms[1])"><br>
            </p>
            <hr>
              <label for="deadName">逝者姓名：</label>
	...
	<form name="form3" method="post" id="form3" action="">
            ...
            <p>
              <input type="button" name="produceQRCode" id="produceQRCode" value="生成遗体二维码" onClick="return produceCodeCallback()" style="width: 129px; ">&nbsp;&nbsp;
              <input type="button" name="printQRCode" id="printQRCode" value="打印遗体二维码" onClick="return printCode()" style="width: 128px; ">&nbsp;&nbsp;
              <input type="button" name="produceFamilyCode" id="produceFamilyCode" value="生成家属二维码" onclick="return produceFamilyCodeCallback()" style="width: 137px; ">&nbsp;&nbsp;
