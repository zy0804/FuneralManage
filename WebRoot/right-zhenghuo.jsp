...
<script type="text/javascript" src="js/right-zhenghuo.js"
	charset="UTF-8">
...
<script>
	...
	function initialization() {
		...
		document.getElementById("inTime").value=myYear+"-"+myMonth+"-"+myDay+" "+myHour+":"+myMin+":"+mySec;
		...
		http_request.open('POST', "RegisterServiceAction!showIdInput", false);
		http_request.setRequestHeader("Content-Type",
				"application/x-www-form-urlencoded");
		http_request.send(null); 
	...
	<div id="TabbedPanels1" class="TabbedPanels">
		...
		<div class="TabbedPanelsContentGroup">
				...
				<form name="form3" method="post" id="form3" action="">
					...
					<p>
						<label for="deadId">逝者身份证号码：</label> <input type="text"
							name="deadInfo.deadId" id="deadId" onchange="return showData()">
						<input type="button" name="ReadCard" id="ReadCard" value="读取身份证号码"
					...
					<p>
						...
						<select
							name="deadInfo.deadSex" id="deadSex">
							<option selected>请选择...</option>
							<option>男</option>
							<option>女</option></select>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; 
							<label for="deadAge">逝者年龄：</label> <input name="deadInfo.deadAge"
							id="deadAge" />&nbsp;&nbsp; 
					</p>
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<label for="deadTime">死亡时间：</label>
						<input type="text" name="deadInfo.deadTime" id="deadTime"
							onfocus="WdatePicker({dateFmt:'yyyy-MM-dd '})">&nbsp; <label
							for="deadKind">死亡类型：</label> <select name="deadInfo.deadKind"
							id="deadKind">
							<option selected>正常</option>
							<option>非正常</option>
						</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;  <label
							for="deadReason">死亡原因：</label>&nbsp;&nbsp;&nbsp;&nbsp; <select
					...
					<p>
						&nbsp; <label for="deadAddress">逝者家庭地址：</label> <input type="text"
							...
							<!--  <label
							for="area">死者所属区域：</label> <select name="deadInfo.area" id="area">
							<option selected>请选择...</option>
							<option>城东新区</option>
							<option>开发区</option>
							<option>五烈镇</option>
					...
					<p>
					<label for="relationship">与逝者关系：</label>
						...
						<p>
						<label
							for="dealerAddress">经办人住址：</label> <input type="text"
					...
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label
							for="invoiceNo"><b>发票号码：</b></label> <input type="text"
							name="invoiceNo" id="invoiceNo" value="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<label for="subsidyNo"><b>惠民补贴凭证号码：</b></label> <input type="text"
							name="subsidyNo" id="subsidyNo" value="0" style="width: 133px; ">&nbsp;&nbsp;
					</p>
					<p>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label for="subsidyMoney"><b>惠民补贴金额：</b></label>
						<input type="text" name="subsidyMoney" id="subsidyMoney" value="0">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp; <label for="benefitTime"><b>惠民补贴办理日期：</b></label>
						<input type="text" name="benefitTime" id="benefitTime"
							onfocus="WdatePicker({dateFmt:'yyyy-MM-dd '})">&nbsp;&nbsp;
						<input type="button" value="确认信息" id="decideInvoiceAndSubsidy"
							onclick="return decideInvoice()">
					</p>
					<hr>
					
					<!-- <p>
						<label for="remainsCarryBeCost">遗体接运应收费用：</label> <input
							type="input" id="remainsCarryBeCost" value="0"
							style="width: 87px; " readonly />元&nbsp;&nbsp; <label
							for="remainsCarryRealCost"><label for="remainsCarryBeCost">遗体接运实收费用：</label> <input type="input"
						...
						<label for="rentCrystalCarBeCost">接运冰棺应收费用：</label> <input
							type="input" id="rentCrystalCarBeCost" value="0"
							style="width: 87px; " readonly />元&nbsp;&nbsp; <label
							for="rentCrystalCarRealCost"><label for="rentCrystalCarBeCost">接运冰棺实收费用：</label> <input type="input"
					...
					<p>
						...
						<select name="urnChoose" id="urnChoose"
							...
							style="width: 92px;" onkeyup="return changeUrnBeCost()" />元&nbsp;&nbsp;
						<label for="urnRealCost">备注：</label> <input type="text"
							name="urnRealCost" id="urnRealCost" value="0"
							style="width: 86px; " onchange="return changeUrnRealCost()">元
					...
					<p>
						<input type="checkbox" id="makeBeautyBox" checked="checked"
							...
							<option>-请选择-</option>
							<option>整容</option>
						</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="makeBeautyBeCost">应收费用：</label>
						<input type="text" name="makeBeautyBeCost" id="makeBeautyBeCost"
							value="0" style="width: 92px;"
							onkeyup="return changeBeautyBeCost()" />元&nbsp;&nbsp; <label
					...
					<p>
						<input type="checkbox" id="leaveRoomBox" checked="checked"
							...
							<option>-请选择-</option>
						</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="leaveRoomBeCost">应收费用：</label>
						<input type="text" name="leaveRoomBeCost" id="leaveRoomBeCost"
							value="0" style="width: 92px;"
							onkeyup="return changeLeaveRoomBeCost()" />元&nbsp;&nbsp; <label
							for="leaveRoomRealCost">备注：</label> 
							<input type="text" name="leaveRoomRealCost" id="leaveRoomRealCost" value="0" onchange="return changeLeaveRoomRealCost()" style="width: 86px; ">
							元
					...
					<p>
						<input type="checkbox" id="cremationBox" checked="checked"
							...
							<option>捡灰炉</option>
							<option>VIP区</option>
						</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label for="cremationBeCost">应收费用：</label>
						<input type="text" name="cremationBeCost" id="cremationBeCost"
							value="0" style="width: 92px;"
							onkeyup="return changeCremationBeCost()" />元&nbsp;&nbsp; <label
            ...
            <p>
              ...
              <input type="text" name="allBeCost" id="allBeCost"
							value="0" style="width: 100px;"
							onkeyup="return changeAllBeCost()" />元&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="hidden" id="allBeCostHidden" value="0">
              <label for="allRealCost"><b>火化服务费用备注：</b></label>
              <input type="text" name="allRealCost" id="allRealCost"
							value="0" style="width: 100px;"
							onkeyup="return changeAllRealCost()" />元
            </p>
            <p>
              
              <input type="button" value="核算" style="margin-left:10px"
							onclick="return sumCost()">
              <label for="sumBeCost" style="margin-left:50px"><b>总应收：</b></label>
			  <input type="text" name="sumBeCost" id="sumBeCost" value="0"
							style="width: 100px;" readonly />元
			  <label for="sumRealCost" style="margin-left:170px"><b>总备注：</b></label>
			  <input type="text" name="sumRealCost" id="sumRealCost" value="0"
							style="width: 100px;" readonly />元
            </p>
            <p>
            <label for="theWholeCost" style="margin-left:120px"><b>总费用：</b></label>
              <input type="text" name="theWholeCost" id="theWholeCost"
							value="0" style="width: 100px;" readonly />元
            ...
            <!--endprint1-->
					<p>
              <input type="button" name="printServiceList"
							id="printServiceList" value="生成服务详单"
							onclick="return outPutServiceList()" style="width: 125px; ">&nbsp;&nbsp;&nbsp;
              <input type="button" name="printServiceList"
							id="printServiceList" value="打印服务详单"
							onclick="return outPrintServiceList()" style="width: 125px; ">
							</p>
              <p><input type="button" name="createSetOrder" id="createSetOrder"
							value="生成套餐单据" disabled="true"
							onclick="return getFunneralGoodsCost()" style="width: 125px; ">&nbsp;&nbsp;&nbsp;
            ...
            <table border="0" width="95%" id="basicInfo"
            	...
            	<tr>
              		<td align="center" colspan="12">
              			<label for="funeralGoods"><b><font
											style="font-size:22px">东台市殡仪馆服务收费单</font></b></label>(三仓分馆)
              		</td>
              	</tr>
              	<tr>
              		<td><b>当日序号：</b></td>
            ...
            <div id="setGoodsPartList">
	            <table border="0" width="95%" id="setBasicInfo"
							style="font-size:12px;border-collapse:collapse;border:0px solid #000;margin-left:30px;">
	            	<tr>
	              		<td align="center" colspan="12">
	              			<label><b><font style="font-size:22px">东台市殡仪馆服务收费单</font></b></label>(三仓分馆)
	              		</td>
	              	</tr>
	              	<tr>
	              		<td><b>当日序号：</b></td>
	            ...
	            <table border="2" width="95%" height="22%" id="setAllGoods"
							style="font-size:12px;border-collapse:collapse;border:1px solid #000;margin-left:30;">
	            	<tr>
	            		<td colspan="1" width="20%"><b>项目</b></td>
	            		<td colspan="2" width="15%"><b>金额</b></td>
	            		<td colspan="7" width="65 %"></td>
	            	</tr>
	            	
	            	 <tr>
	            		<td colspan="1" height="15%" id="setItem1"></td>
	            		<td colspan="2" id="itemPrice1"></td>
	            		<td colspan="7" id="setServiceDetail"></td>
	            	</tr> 
	            	...
	            	<tr>
	            		...
	            		<td colspan="2" id="itemPrice4"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="15%" id="setItem5"></td>
	            		<td colspan="2" id="itemPrice5"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="15%" id="setItem6"></td>
	            		<td colspan="2" id="itemPrice6"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="15%" id="setItem7"></td>
	            		<td colspan="2" id="itemPrice7"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="15%" id="setItem8"></td>
	            		<td colspan="2" id="itemPrice8"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="15%" id="setItem9"></td>
	            		<td colspan="2" id="itemPrice9"></td>
	            		<td colspan="7"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="10%"><b>合计</b></td>
	            		<td colspan="2" id="setAllCost"></td>
	            		<td colspan="2" width="20%"><b>大写</b></td>
	            		<td colspan="5" id="setAllCostUp" width="70%"></td>
	            	</tr>
	            	<tr>
	            		<td colspan="1" height="10%"><b>开票员</b></td>
	            		<td colspan="2"></td>
	            		<td colspan="3"><b>管理员</b></td>
	            		<td colspan="4"></td>
	            		
	            	</tr>
	            	<tr>
	            <td colspan="6" ><b>(明白消费 确认签字)客户主办人签字 </b>   </td>
	            <td colspan="4" ></td>
