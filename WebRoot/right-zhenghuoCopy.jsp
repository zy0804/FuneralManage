	  ...
	  <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent">
          <form name="form1" id="form1" onsubmit="return validateForm1(this);">
            ...
            <p>
              ...
              <select name="deadInfo.deadSex" id="deadSex">
            ...
            <p>
              ...
              <select name="deadInfo.deadReason" id="deadReason" onChange="return getDetails()">
            ...
            <p>
              <label for="operatorRelation">与经办人关系：</label>
            ...
            <p>
              ...
              <input type="button" name="ReadDealerCard" id="ReadDealerCard" value="读取身份证号码" onclick="return readDealerCard()" style="width: 125px; ">&nbsp;&nbsp;&nbsp;
            ...
            <p>
              ...
              <input type="text" name="deadInfo.dealerAddress" id="dealerAddress" style="width: 474px; ">&nbsp;&nbsp;&nbsp;
            </p>
            <hr>
            <p>
        ...
        <div class="TabbedPanelsContent">
          ...
          <!--startprint1-->
            <p>
              <label for="deadId">逝者身份证号码：</label>
              <input type="text" name="deadInfo.deadId" id="deadId" onchange="return showData(this)">
