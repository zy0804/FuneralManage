...
&nbsp;&nbsp;&nbsp;
   ...
   <thead>   
            ...
            <tr>
            <th colspan="12" align="center"><b><font style="font-size:24px">东台市殡仪馆火化基本信息统计表</font></b>(三仓分馆)</th> 
            </tr>
            <tr>
            <th>火化日期</th> 
            <th>序号</th>
...
()" style="width: 125px; ">&nbsp;&nbsp;&nbsp;
            ...
            <table align="center"  border="0" width="95%" id="basicInfo" style="font-size:12px;border-collapse:collapse;border:0px solid #000;">
            	...
            	<tr>
              		<td align="center" colspan="12">
              			<label for="funeralGoods"><b><font style="font-size:22px">东台市殡仪馆服务收费单</font></b></label>(三仓分馆)
              		</td>
              	</tr>
              	<tr>
	...
	function getAuditCallback()   //回调函数
	{
		if(xmlHttpRequest.readyState == 4 && xmlHttpRequest.status == 200)
		{
			...
			document.getElementById("yttsl").innerText = json[7].iCou;//大礼厅
			document.getElementById("yttje").innerText = json[7].iCos;
			document.getElementById("batsl").innerText = json[8].iCou;//小礼厅
