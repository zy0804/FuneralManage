...
<html>
  <head>
    ...
    <script type="text/javascript" src="js/warehouseMoveManage/updateWarehouseMove.js"></script>
  ...
  <body>
  <form id="form1" name="form1" method="post" action="" onsubmit="return updateWarehouseMove();">
      <table>
        <tr>
          <td>调拨单号：</td>
          ...
          <td>调拨日期：</td>
          <td><input type="text" id="moveDate" name="moveDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',readOnly:true,minDate:''})" onchange="checkDate();"/></td>
        </tr>
        <tr>
          <td>调出仓库：</td>
      ...
      <table id="table" name="table" border="1">
        <thead>
          <tr>
            ...
            <th style="display:none; width:120px;">原调拨数量</th>
          </tr>
        </thead>
        <tbody>
        </tbody>
