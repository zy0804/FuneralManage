...
public class AddServiceAction extends ActionSupport{
	...
	public String addService(){
		...
		if(makeBeauty.length()>1){
			...
			returnString=addServiceDao.insertIntoService(deadId,deadMakeBeauty)+"02";
		}
		...
		returnString=addServiceDao.insertLastService(deadId,"00","00","0");
		return "addService";
	}
}
