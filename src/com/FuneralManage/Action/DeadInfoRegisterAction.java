...
public class DeadInfoRegisterAction extends ActionSupport{
	...
	public String registDeadInfo() throws SQLException{
	...
	public String decideInvoiceAndSubsidy() {
		...
		DeadInfoRegisterService deadInfoRegisterService = new DeadInfoRegisterService();
		returnString = deadInfoRegisterService.judge(deadInfo);
