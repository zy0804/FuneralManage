...
public class DeleteWarehouseCheckAction extends ActionSupport {
	 ...
	 * @return 删除结果
	 */
	public String deleteWarehouseCheck()
	{
		WarehouseCheckService warehouseCheckService = new WarehouseCheckService();
		...
		// 删除盘点单信息
		boolean result = warehouseCheckService.deleteWarehouseCheck(warehouseCheckNumber, goodsList);
